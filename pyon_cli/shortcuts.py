"""Create shortcut commands for easier Pyon usage."""
...
def create_shortcuts():
    """Create batch file shortcuts for common Pyon commands."""
...
def setup_environment():
    ...
    console.print("[blue]Setting up Pyon development environment...[/blue]")
    ...
    if Path("pyon_config.json").exists():
        ...
        checks.append("⚠️ Not in Pyon project directory")
